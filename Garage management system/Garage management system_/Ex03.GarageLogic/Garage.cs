...
namespace Ex03.GarageLogic
{
    public class Garage
    {
        ...
        public void AddVehicle(string i_LicenseNumber, Vehicle i_Vehicle, string i_OwnerName, string i_OwnerPhone, string i_ManufacturerWheelName)
        {
            ...
            {
                wheel.ManufacturerName = i_ManufacturerWheelName;
            }
        }
